    ...
    useEffect(() => {
        ...
        async function fetchPost() {
            try {
                ...
                console.log("There was a problem or request was cancled")
            ...
            <div className="d-flex justify-content-between">
                ...
                {isOwner() && (
                    <span className="pt-2">
                        ...
                        <a onClick = {deleteHandler} data-tooltip-content="Delete" data-tooltip-id="delete" className="delete-post-button text-danger"><i className="fas fa-trash"></i></a>
